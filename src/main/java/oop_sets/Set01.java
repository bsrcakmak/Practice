...
//        Set01<Integer> setYear = new HashSet<>(Arrays.asList(76,-16,-99,21,101));
//        Set01 setYear1 = new HashSet<>(Arrays.asList(76,-16,-99,21,101));//<> içinde wrapper class yazmadan da oldu
//
